...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Inventory",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9Inventory11AppDelegate")
...
SWIFT_CLASS("_TtC9Inventory23InventoryViewController")
@interface InventoryViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextView * _Null_unspecified productsTextView;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC9Inventory13SceneDelegate")
